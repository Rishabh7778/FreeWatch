...
export const MovieDetails = () => {
  ...
  useEffect(() => {
    async function fetchMovie() {
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=f926b05559b9456afb2ec865c6a74fa9`);
    ...
    <main>
      <section className="flex justify-around flex-wrap py-5">
        ...
        <div className="max-w-2xl text-gray-800 text-lg dark:text-white">
          <h1 className="text-4xl font-fold my-3 lg:text-left">{movie.title}</h1>
          ...
          <div className="flex items-center">
            ...
            <p clasNames="ms-2 text-gray-900 dark:text-white">{movie.vote_average}</p>
